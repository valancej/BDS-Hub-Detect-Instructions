...
You can automatically import certificates from your instance of the Hub. This is a conveniece feature, and your certificates should be imported by your administrator. However, if the certificate is not imported, Hub Detect imports the certificate for you using the following property set to true.
